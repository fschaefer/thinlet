...
public class Converter {
	public static void main(String[] args) throws Exception {
		FileInputStream fis = new FileInputStream("../Thinlet.java");
		byte[] data = new byte[fis.available()];
		fis.read(data, 0, data.length);
		fis.close();
		String source = new String(data);
		
		FileInputStream efis = new FileInputStream("eventcode.txt");
		...
		FileOutputStream fos = new FileOutputStream("Thinlet.java");
